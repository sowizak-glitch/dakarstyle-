...
assert.match(edge, /verify_jwt/i.test('verify_jwt') ? /Deno\.serve/ : /Deno\.serve/);
...
assert.match(router, /import frontend from '\.\/senecompare-v53\.js'/);
assert.match(router, /const RELEASE = '5\.3\.0'/);
assert.match(router, /senecompare-admin-v53/);
assert.match(router, /Authorization/);

console.log('SeneCompare 5.3 static privacy, security and monetization audit passed');
