(() => {
  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      .sbfr-client-card .sbfr-balance-ok{color:#0b6b4a}
      .sbfr-client-card .sbfr-balance-due{color:#a33b3b}
  ...
  function decorateCard(card) {
    ...
    if (paidValue) paidValue.textContent = fmt(paid);
    ...
    averageChip.innerHTML = purchaseCount > 0
